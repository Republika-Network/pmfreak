...
export const PRIVILEGED_ACCESS_REGISTRY: readonly PrivilegedAccessEntry[] = [
  ...
  },
  {
    ...
    mitigations: [
      ...
      "The legacy resolver takes no workspace input at all — its redirect destination is derived from pmos.workspace_id, so no cookie, preferred workspace or shell context can influence where a legacy PMO link lands",
