...
/**
 * Project details — `/workspaces/[workspaceId]/projects/[projectId]/overview`.
 *
 * CHAT-SHELL-01 moved this screen one segment down, unchanged. The family root
 * is now the project CONVERSATION (Project Brain in the centre of the shell, the
 * operational tools beside it); this is the screen the root used to render, and
 * everything on it — identity, execution CRUD, PM assignment, the analysis entry
 * point, prior analyses — still lives here and is linked from the conversation's
 * Project tool and the tab strip. Its authority model below did not change.
 *
 * What follows is this screen's original record, written when it was the root.
 *
