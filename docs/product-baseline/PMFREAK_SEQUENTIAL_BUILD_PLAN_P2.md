...
| P2-16 | WP8 | A/C | VERIFIED | `d001345d` (final, exact-head re-verified; `b602363e` superseded after review reopened it) | G1, P2-04 VERIFIED | 159 critical-path + 46 P2-16; check:p2-16-db 200; operational-flow-db ok; fresh-DB 167/167; SD 33 (authenticated 23); npm test 14,492/0 fail; Chromium P2-16 11/11 + P2-14 38/38; typecheck; lint 0 errors/643 (= baseline); build | contributes to G4 | — (Codex review findings #1–#5 repaired) | P2-17 unlocked; do not auto-start |
| P2-17 | WP9 | A/C | VERIFIED | `9b9f689e` | P2-16 VERIFIED | 207 focused + 1 module-mock; operational-flow-db ok; npm test 14,522/0 fail; Chromium P2-17 9/9 ×3; typecheck; lint 0 errors/642; build; AOC/auth-bypass | G4 technically unlocked (P2-16 + P2-17); G4 not verified | — | G4 review; do not auto-start |
