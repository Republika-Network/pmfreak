...
| P2-18 | WP10 | A | VERIFIED | `a32335ff` | P2-10 VERIFIED | 23 P2-18 + 77 minimum acceptance + 122 canonical contracts + 81 P2-16/17; check:p2-18-db 146 (LIVE lineages; idempotency, concurrency, supersession, RLS/IDOR, provenance guard); fresh-DB 168/168; operational-flow-db 22/22; p2-09-db 74; p2-16-db 200; SD 34 (authenticated 24); npm test 14,549 (2 WSL line-ending, 7/7 native); typecheck; lint 0 errors/642; build 417 | contributes to Expansion gate | — | P2-19 unlocked; do not auto-start |
