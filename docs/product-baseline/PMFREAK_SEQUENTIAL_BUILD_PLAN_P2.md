...
| P2-18 | WP10 | A | VERIFIED | `fc4b2166` (final; `a32335ff` and `b93dd9fb` superseded after review) | P2-10 VERIFIED | 18 P2-18 + 77 minimum acceptance + 122 canonical contracts + 81 P2-16/17; check:p2-18-db 200 (LIVE lineages; idempotency, concurrency, supersession, validity at the database clock, RLS/IDOR, no direct DML for any role incl. service_role, provenance guard); fresh-DB 168/168; operational-flow-db 22/22; p2-09-db 74; p2-16-db 200; SD 34 (authenticated 24); npm test 14,544 (2 WSL line-ending, 7/7 native); typecheck; lint 0 errors/642; build 417 | contributes to Expansion gate | — (Codex review findings repaired: service-role DML + 6 on `b93dd9fb`) | P2-19 unlocked; do not auto-start |
| P2-19 | WP10 | B/C | VERIFIED | `f03b1183` | P2-18 VERIFIED | 25 P2-19 + minimum acceptance + governance contracts; check:p2-19-db 270 (LIVE P2-18 lineages; owner/admin via knowledge.ratify/reject/revoke, PM/viewer/agent denied, stale review, not-supported, one terminal review per exact Candidate state, ratify/reject race, idempotency, revocation, retrieval exclusions, explicit validity, no direct DML for any role incl. service_role; ×3 incl. fresh schema); Chromium P2-19 9/9; fresh-DB 169/169; p2-18-db 200; p2-06-db 50 (generic knowledge_elevation still denied); p2-07/p2-14/p2-09/p2-16/operational-flow db PASS; SD 37 (authenticated 27); npm test 14,569 (2 WSL line-ending, 7/7 native); typecheck; lint 0 errors/642; build 420 | Expansion gate unlocked / ready for certification | — | certify the Expansion gate on `main` after merge; do not auto-start |
