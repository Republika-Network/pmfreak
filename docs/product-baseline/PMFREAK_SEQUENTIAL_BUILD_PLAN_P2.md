...
| P2-16 | WP8 | A/C | VERIFIED | `b602363e` (exact-head re-verified) | G1, P2-04 VERIFIED | 159 critical-path + 36 P2-16; check:p2-16-db 132; operational-flow-db ok; fresh-DB 167/167; SD 33; npm test 14,482/0 fail; Chromium P2-16 10/10 + P2-14 38/38; typecheck; lint 0 errors/643 (= baseline); build | contributes to G4 | — | P2-17 unlocked; do not auto-start |
